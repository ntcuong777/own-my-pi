...
export function getNormalizedCursorToolName(toolCall) {
    return classifyCursorToolVisibility(toolCall).normalizedName;
}
export function classifyCursorToolVisibility(toolCall) {
...
export function isFastLocalDiscoveryTool(toolCall) {
