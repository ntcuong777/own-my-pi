...
async function prepareCursorLocalProviderTurn(prepareParams) {
    ...
    try {
        ...
        const { Agent } = sdk;
        const useHttp1ForAgent = configureCursorSdkHttp1(sdk, resolvedConfig.local.useHttp1ForAgent);
