import { registerCursorCloudLifecycleLedger, runCursorCloudLifecycleCommand, } from "./cursor-cloud-lifecycle.js";
...
export function formatResolvedCursorRuntime(runtime) {
...
export function consumeCursorLocalForceOverride(resolved) {
    if (!resolved.value)
        return false;
...
function persistCursorRuntimePreference(pi, runtime, cloudAcknowledged = false) {
