> Vendored into own-my-pi from [@piex-dev/goal](https://github.com/piex-dev/piex/tree/main/extensions/goal) (`5cd4467`). Author: [debugtalk](https://github.com/debugtalk). MIT.
